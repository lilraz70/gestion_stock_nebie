            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Facture client</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                <li class="breadcrumb-item active">Facture client</li>
                            </ol>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('credit.customer') }}"
                                class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i
                                    class="fa fa-list"> Back </i></a> <br> <br>

                            <div class="row">
                                <div class="col-12">
                                    <div>
                                        <div class="p-2">
                                            <h3 class="font-size-16"><strong>Facture client ( Facture No:
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <form method="post"
                                        action="{{ route('customer.update.invoice', $payment->invoice_id) }}">
                                        @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" name="paid_amount"
                                                            ...
                                                            placeholder="Entrez le montant payé" style="display:none;">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <div class="md-3">
                                                            ...
                                                            <input class="form-control example-date-input"
                                                                placeholder="YYYY-MM-DD" name="date" type="date"
                                                                id="date">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <div class="md-3" style="padding-top: 30px;">
                                                            <button type="submit" class="btn btn-info">Mise à jour de la
                                                                facture</button>
                                                        </div>
