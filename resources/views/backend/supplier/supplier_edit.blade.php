                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Modification d'un fournisseur </h4><br><br>
                            ...
                            <form method="post" action="{{ route('supplier.update') }}" id="myForm">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="mobile_no" value="{{ $supplier->mobile_no }}" class="form-control"
                                            type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="email" value="{{ $supplier->email }}" class="form-control"
                                            type="email">
                                    </div>
                                </div>
                                <!-- end row -->
        ...
        $(document).ready(function() {
            $('#myForm').validate({
                ...
                messages: {
                    ...
                    address: {
                        required: "S'il vous plaît entrez votre adresse",
                    },
                },
                errorElement: 'span',
