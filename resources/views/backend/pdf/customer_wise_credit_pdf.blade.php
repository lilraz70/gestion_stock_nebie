                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Rapport de crédit client avisé</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">Rapport de crédit client avisé</li>
                                        </ol>
                                    </div>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>Facture No  </strong>
            </td>
            <td class="text-center"><strong>Date</strong>
            </td>
            
            <td class="text-center"><strong>Montant dû  </strong>
            </td>
