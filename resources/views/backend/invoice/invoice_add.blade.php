...
<div class="col-12">
    <div class="card">
        <div class="card-body"> 
            ...
            <h4 class="card-title">Ajouter une facture  </h4><br><br>
    ...
    <div class="row">
         ...
         <div class="col-md-1">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Facture No</label>
       ...
       <div class="col-md-3">
         ...
         <div class="col-md-3">
           ...
           <div class="col-md-1">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Stock(quantité)</label>
        ...
        <tr>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <textarea name="description" class="form-control" id="description" placeholder="Écrivez la description ici"></textarea>
                </div>
            </div><br>

            <div class="row">
                <div class="form-group col-md-3">
                    <label> Statut payant </label>
                    <select name="paid_status" id="paid_status" class="form-select">
                        <option value="">Selectionner </option>
                        <option value="full_paid">Entièrement payé </option>
                        <option value="full_due">Entièrement dû </option>
                         <option value="partial_paid">Partiellement payé </option>
                        
                    </select>
        <input type="text" name="paid_amount" class="form-control paid_amount" placeholder="Entrez le montant payé" style="display:none;">
                </div>
...
<div class="row new_customer" style="display:none">
    <div class="form-group col-md-4">
        <input type="text" name="name" id="name" class="form-control" placeholder="Écrire le nom du client">
    </div>

    <div class="form-group col-md-4">
        <input type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="Écrire le téléphone du client">
    </div>

    <div class="form-group col-md-4">
        <input type="email" name="email" id="email" class="form-control" placeholder="Écrire l´email du client">
    </div>
</div>
