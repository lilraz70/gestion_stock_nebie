...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Rapport de facturation quotidien</h4><br><br>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="md-3 form-group">
                <label for="example-text-input" class="form-label">Date de début</label>
        ...
        <div class="col-md-4">
            <div class="md-3 form-group">
                <label for="example-text-input" class="form-label">Date de fin</label>
