                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Rapport visé sur les fournisseurs et les produits</h4>
 ...
 <script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                supplier_id: {
                    required : 'Veuillez sélectionner le fournisseur',
                },
