...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Ajouter un achat </h4><br><br>
    ...
    <div class="row">
       ...
       <div class="col-md-4">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Nom de catégorie </label>
                <select name="category_id" id="category_id" class="form-select select2" aria-label="Default select example">
                <option selected="">Ouvrir ce menu de sélection</option>
                @foreach($category as $supp)
                <option value="{{ $supp->id }}">{{ $supp->name }}</option>
               @endforeach
                </select>
            </div>
