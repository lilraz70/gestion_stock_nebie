            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Toutes les catégories</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('category.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light"
                                style="float:right;"><i class="fas fa-plus-circle"> Ajout d'une catégorie </i></a> <br> <br>

                            <h4 class="card-title">Catégorie Toutes les données </h4>
