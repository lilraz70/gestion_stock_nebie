  <header id="page-topbar">
      <div class="navbar-header">
          <div class="d-flex">
              ...
              <button type="button" class="btn btn-sm px-3 font-size-24 header-item waves-effect mt-4"
              ...
              <div class="dropdown d-inline-block user-dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="{{ route('change.password') }}"><i
                              class="ri-wallet-2-line align-middle me-1"></i> Changer le mot de passe</a>
                      {{-- 
            <a class="dropdown-item d-block" href="#"><span class="badge bg-success float-end mt-1">11</span><i class="ri-settings-2-line align-middle me-1"></i> Paramétre</a>
